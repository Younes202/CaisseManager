	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			<div class="row" style="margin-left: 0px;margin-right: 0px;">
				...
				<div class="col-lg-3 col-sm-3 col-xs-3">
					 <div class="spinbox spinbox-horizontal spinbox-two-sided">
	                      ...
	                      <std:text name="quantite_custom" forceWriten="true" type="long" style="width: 83%;font-size: 20px;" value="${quantite_custom }" classStyle="spinbox-input form-control" />
			...
			<div class="row" style="text-align: center;">
				<div class="col-md-12">
					<std:button actionGroup="X" classStyle="btn btn-success" style="border-radius: 37px;height: 52px;font-size: 21px;" action="caisse-web.caisseWeb.changeQuantite" targetDiv="left-div" params="${params }" icon="fa-save" value="Valider" closeOnSubmit="true" />
				</div>
			</div>
		</div>
	</div>
