	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			<div class="row" style="text-align: center;">
				<div class="col-md-12">
					<std:button actionGroup="X" style="border-radius: 37px;height: 42px;font-size: 21px;" classStyle="btn btn-success" action="caisse-web.caisseWeb.addCommentaireCommande" targetDiv="left-div" params="${params }" icon="fa-save" value="Valider" closeOnSubmit="true" />
				</div>
			</div>
		</div>
	</div>
