...
$(document).ready(function() {
  /*$("#client\\.telephone").keyup(function() {
    	var field = document.getElementById('showSendButt');
  ...
  $("#showSendButt").click(function() {
	...
	<div class="form-group">
		...
		<div class="col-xs-8 col-md-8">
			<std:text name="client.telephone" type="string" mask="99-99-99-99-99" style="width:120px;" />
<%--          	<std:button classStyle="css" id="showSendButt" params="skipF=1" action="caisse.clientMobile.generateSmsToken" icon="fa-send" value="Recevoir le code" /> --%>
<!--             <div id="inputSms" style="margin-top: 7px;display: none;">Code de vérification : -->
