					...
					<div class="col-lg-4 mb-3">
						<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
							<div class="list-card-image">
								...
								<std:link action="caisse.clientMobile.loadMenuEtapes" targetDiv="detail-content" params="skipF=1"> 
									<img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending1.png" class="img-fluid item-img w-100">
								</std:link>
							</div>
							<div class="p-3 position-relative">
								<div class="list-card-body">
									<h6 class="mb-1">
										<a href="restaurant.html" class="text-black"><%=menuP.getLibelle() %> </a>
									</h6>
