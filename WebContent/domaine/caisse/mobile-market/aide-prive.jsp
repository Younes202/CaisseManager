<div class="rounded shadow-sm">
	<div class="osahan-privacy bg-white rounded shadow-sm p-4">
		<div id="intro" class="mb-4">
			...
			<p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Foodride"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.</p>
		...
		<div id="services" class="mb-4">
			...
			<ul class="text-secondary">
				<li class="pb-2">When you register for a Foodride account we collect your full name, email address, and account log-in credentials.</li>
				...
				<li class="pb-2">When you use the "Remember Me" feature of Foodride Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
			</ul>
			<p>When you respond to Foodride emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call Foodride. If you contact us by phone as a Foodride User, we may collect additional information in order to verify your identity.</p>
		...
		<div id="privacy" class="mb-4">
			...
			<p>Foodride's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that Foodride - Online Food Ordering Website Template can use such data in accordance with our privacy policies.</p>
