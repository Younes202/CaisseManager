	<div class="osahan-favorites">
		<div class="d-none">
			<div class="bg-primary border-bottom p-3 d-flex align-items-center">
				...
				<h4 class="font-weight-bold m-0 text-white">Tendances</h4>
			</div>
		</div>

		<div class="container most_popular py-5">
			<h2 class="font-weight-bold mb-3">Tendances</h2>
			<div class="row">
				...
				<div class="col-md-4 mb-3">
					<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
						<div class="list-card-image">
							...
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending5.png" class="img-fluid item-img w-100">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
				...
				<div class="col-md-4 mb-3">
					<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
						<div class="list-card-image">
							...
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending6.png" class="img-fluid item-img w-100">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
								<h6 class="mb-1">
									<a href="restaurant.html" class="text-black">Bite Me Sandwiches</a>
								</h6>
				...
				<div class="col-md-4 mb-3">
					<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
						<div class="list-card-image">
							...
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending7.png" class="img-fluid item-img w-100">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
				...
				<div class="col-md-4 mb-3">
					<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
						<div class="list-card-image">
							...
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending4.png" class="img-fluid item-img w-100">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
				...
				<div class="col-md-4 mb-3">
					<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
						<div class="list-card-image">
							...
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending8.png" class="img-fluid item-img w-100">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
