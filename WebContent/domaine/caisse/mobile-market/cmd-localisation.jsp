				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-6">
						<div class="bg-white p-4 shadow-lg rounded mb-2">
							...
							<h6 class="mb-1 mt-1">
								<a href="restaurant.html" class="text-black">Spice Hut Restaurant </a>
							</h6>
							<p class="text-gray mb-0">
								<i class="feather-clock"></i> 04:19 PM | 8 Items | $314
							</p>
						</div>
							...
							<div class="osahan-track-order-detail po">
								...
								<div class="row">
									<div class="col-md-5">
										<small>FROM</small>
										<h6 class="mb-1 mt-1">
											<a href="restaurant.html" class="text-black"><i class="feather-shopping-cart"></i> Spice Hut Restaurant </a>
										</h6>
										<p class="text-gray mb-5">2036, NEW YORK</p>
										<small>DELIVER TO</small>
										<h6 class="mb-1 mt-1">
											<span class="text-black"><i class="feather-map-pin"></i> Other </span>
										</h6>
									...
									<div class="col-md-7">
										...
										<p class="mb-2">
											<i class="feather-ui-press text-danger food-item">·</i> Chicken Tikka Sub 12" (30 cm) x 1 <span class="float-right text-secondary">$314</span>
										</p>
										<p class="mb-2">
											<i class="feather-ui-press text-success food-item">·</i> Corn &amp; Peas Salad x 1 <span class="float-right text-secondary">$209</span>
										</p>
										<p class="mb-2">
											<i class="feather-ui-press text-success food-item">·</i> Veg Seekh Sub 6" (15 cm) x 1 <span class="float-right text-secondary">$133</span>
										</p>
										<p class="mb-2">
											<i class="feather-ui-press text-danger food-item">·</i> Chicken Tikka Sub 12" (30 cm) x 1 <span class="float-right text-secondary">$314</span>
										</p>
										...
										<p class="mb-0 font-weight-bold text-black">
											TOTAL BILL <span class="float-right text-secondary">$209</span>
										</p>
										<p class="mb-0 text-info">
											<small>Paid via Credit/Debit card <span class="float-right text-danger">$620 OFF</span></small>
										</p>
									</div>
								</div>
							</div>
		...
		<div class="container slider_restaurant py-5 border-top">
			<div class="trending-slider">
				<div class="osahan-slider-item px-1">
					<div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
						<div class="list-card-image">
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending1.png" class="img-fluid item-img">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
								<h6 class="mb-1">
									<a href="restaurant.html" class="text-black">Dave's Bar-B-Que</a>
								</h6>
								<p class="text-gray mb-2">963 Madyson Drive Suite 679</p>
								<p class="text-warning mb-0">
									<i class="feather-star"></i><i class="feather-star"></i><i class="feather-star"></i><i class="feather-star"></i><i class="feather-star"></i>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="osahan-slider-item px-1">
					<div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
						<div class="list-card-image">
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending2.png" class="img-fluid item-img">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
				...
				<div class="osahan-slider-item px-1">
					<div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
						<div class="list-card-image">
							<a href="restaurant.html"> <img alt="#" src="domaine/caisse/mobile-market/template/resources/img/trending3.png" class="img-fluid item-img">
							</a>
						</div>
						<div class="p-3 position-relative">
							<div class="list-card-body">
