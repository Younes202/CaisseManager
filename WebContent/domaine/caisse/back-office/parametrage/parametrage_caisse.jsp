		...
		<%} %>
			<div class="widget-body">
					...
					<c:forEach items="${listParams }" var="parametre">
						<c:if test="${parametre.groupe == 'CAISSE'}">
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<c:choose>
										<c:when test="${parametre.code == 'PRINT_FACTURE_PRINTER' }">
				...
				<div class="row" style="margin-top: 25px;">
					<h3 style="color: #2dc3e8;padding-left: 20px;border-bottom: 1px dashed rgba(0, 0, 0, .2);">IMAGE MISE EN VEILLE CAISSE</h3>
					<div class="col-md-12">
						<div class="col-md-3">
							<!-- Photos -->
							<div id="fileLoadDiv">
