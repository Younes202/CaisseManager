			...
			<div class="row" style="margin-left: 13px;">
				<%if(listAgencement.size() > 0){ %>
					<div class="form-group">
						<std:label style="text-align:left;" classStyle="control-label col-md-12" value="Table destination" />
					</div>	
					<div class="form-group">
						<div class="col-md-12">
				...
				<div class="form-group">
					<div class="col-md-12">
						<std:label style="text-align:left;" classStyle="control-label col-md-12" value="Client destination" />
					</div>	
				</div>
				<div class="form-group">
					<div class="col-md-12">
				...
				<c:if test="${CURR_ART_TRANS.quantite > 1 }">
					<div class="form-group">
