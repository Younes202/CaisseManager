	...
	<div class="row" style="margin-bottom: 10px;margin-left: 14px;">
		<table>
			...
			<tr style="line-height: 35px;">
				...
				<td nowrap="nowrap" colspan="4"><std:select name="caisse.id" mode="std" type="long" data="${listCaisse }" key="id" labels="reference" value="${currCaisseId }" onChange="$('#histo-lnk').trigger('click');" width="100%" /></td>
			</tr>
			<%
				}
			%>
			<tr style="line-height: 35px;">
				...
				<td>
					<std:text name="ref_rep_cmd" type="string" value="${curr_rep_ref }" onChange="$('#histo-lnk').trigger('click');" style="width:100%;" />
				</td>
			</tr>	
		</table>
	</div>
