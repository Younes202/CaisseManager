			...
			<div class="row" style="text-align: center;">
				<div class="col-md-12">
					...
					<%} else{ %>
						...
						<std:button id="auth_act_lnk2" actionGroup="M" classStyle="btn btn-lg btn-success" action="caisse-web.caisseWeb.confirmAnnuleCmd" targetDiv="${tarDiv }" params="tp=${tp}&workId=${mvm }&caisse.id=${caisse }" workId="${cmdWid }" closeOnSubmit="true" icon="fa-save" value="S'authentifier" />
					<%} %>
					<button type="button" id="close_modal" class="btn btn-lg btn-primary" data-dismiss="modal">
						<i class="fa fa-times"></i> Fermer
					</button>
