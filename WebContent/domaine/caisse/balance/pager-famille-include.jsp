...
<div style="float: left;width: 100%;overflow: hidden;">
	...
	<std:link params="is_top=1" style='${balance.GET_STYLE_CONF("BUTTON_FAMILLE", "COULEUR_TEXT_FAMILLE")};' action="caisse-web.balance.familleEvent" targetDiv="menu-detail-div" workId="<%=familleP.getId().toString() %>" classStyle="caisse-top-btn famille-btn" value="">
