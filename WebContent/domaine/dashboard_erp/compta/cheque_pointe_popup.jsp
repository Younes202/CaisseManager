		...
		<div class="widget-body">
			...
			<div class="row">
					...
					<div class="row" style="text-align: center;">
						<div class="col-md-12">
							<std:button classStyle="btn btn-success" targetDiv="dash-cheque" closeOnSubmit="true" action="dash.dashCompta.pointer_cheque" workId="${elementId }" icon="fa-save" value="Pointer" />
