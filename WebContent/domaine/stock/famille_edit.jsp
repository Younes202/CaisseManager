	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			<div class="row" style="margin-top: 10px;">
				...
				<c:if test="${familleLevel >= 1 }">
				<%if(tp.equals("EM")){ %>	
				<div class="form-group">
				<std:label style="margin-left: 5em;" classStyle="control-label col-md-2" value="Nombre de Personne"/>
<!-- 				placeholderKey="famille.nbrPersonne" -->
						<div class="col-md-4">
							<std:text name="famille.nbrPersonne" type="long" placeholder="Max" required="true"  style="width: 40%;" maxlength="14"/>
						</div>
				</div>
				<%} %>
				</c:if>
