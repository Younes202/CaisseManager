...
<std:form name="data-form">
	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			<c:forEach items="${listMenus }" var="menu">
				<div class="row" style="margin-top: 4px;">
					<div class="col-md-8">
						${menu.code }-${menu.libelle }
					</div>
					<div class="col-md-4">
						<std:text name="menuOrder_${menu.id }" type="long" placeholder="Ordre" maxlength="3" value="${cpt }" style="width: 50px;" />
					</div>
				</div>
		...
		<div class="modal-footer">
			<std:button actionGroup="M" classStyle="btn btn-success" action="caisse.menuComposition.ordonnerMenu" icon="fa-save" value="Sauvegarder" />
