		      	...
		      	for(CaisseMouvementArticlePersistant caisseMvmP : listSortedArticle){
		      		    ...
		      		    boolean isDeviseLine = (BooleanUtil.isTrue(caisseMvmP.getIs_devise()) || BooleanUtil.isTrue(CURRENT_COMMANDE.getIs_devise()));
		      		     ...
		      		     if(BooleanUtil.isTrue(caisseMvmP.getIs_suite_end())){
		      		   	 ...
		      		   	 if(!BigDecimalUtil.isZero(caisseMvmP.getMtt_reduction())){
		   		    		libCmd = libCmd + " <i isoffR='1' class='fa fa-gift'style='color:red;font-size: 17px;cursor:pointer;' data-container='body' data-titleclass='bordered-blue' data-class='' data-toggle='popover' data-placement='top' data-title='Article réduit' data-content='Prix : "+BigDecimalUtil.formatNumber(caisseMvmP.getMtt_total())+"' data-original-title='' title=''></i>";
		   				  }
       	       		    	   ...
       	       		    	   if(type.equals(TYPE_LIGNE_COMMANDE.ART.toString())){
					        	       ...
					        	       <%
		        	       		       ...
		        	       		       String params = (BooleanUtil.isTrue(caisseMvmP.getIs_offert())?"isaf=1&":"") 
		        	       		    						+ (!BigDecimalUtil.isZero(caisseMvmP.getMtt_reduction())?"isafR=1&":"")				
		        	       		    		   				+"cli="+i
