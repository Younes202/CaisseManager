...
/* 			$("#toogle-detail").click(function(){
	...
	//		$("#left-div").css("height", (widowHeight-103)+"px");
		...
		function openType(type) {
			  $(".btn-grad").removeClass("btn-gradFocus");
			  $(".type-cmd").hide();
			  $("#"+type).show(); 
			  $("#"+type+"B").addClass("btn-gradFocus");
			}		
		</script>		
	...
	<div class="row">
		...
		<!-- ***************************************************** -->			
			...
			<div class="page-body" style="position:fixed; margin: 0px;padding: 0px;margin-top: 40px;    width: 100%;background-color: #FFBF9B;height: 100%;">
				<div class="widget">
				<std:form name="data-form">
					...
					<div style="float: left;width: 100%;" id="right-div">
					...
					<div style="width: 50%;
							    top: 84%;
							    right: 9px;
							    height: 458px;" id="left-div">
			         	<%=CaisseWebBaseAction.GET_STYLE_CONF("PANEL_LEFT", null)%>
