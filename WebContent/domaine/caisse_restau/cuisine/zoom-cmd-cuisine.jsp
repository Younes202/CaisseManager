...
boolean isCuisine = "C".equals(request.getAttribute("tp"));
String tp = (String)ControllerUtil.getUserAttribute("tp", request);

if(tp == null){
	tp = (String)request.getAttribute("tpStatut");
}
	             ...
	             <div style="width: 300px;float: left;">
		    		...
		    		<%
		    						...
		    						CaisseMouvementArticlePersistant lastDetailAvecStatut = null;
		    						      ...
		    						      if(isInCaisseConf	&& !BooleanUtil.isTrue(caisseMvmP.getIs_annule()) && ( 
		    		...
		    		%>
		    				...
		    				<%}
						      ...
						      if(caisseMvmP.getMenu_idx() != null || type.equals(TYPE_LIGNE_COMMANDE.MENU.toString())){
						       ...
						       //
						       if (isToAdd && (!isArticle || (isArticle && (!isCuisine || "C".equals(caisseMvmP.getOpc_article().getDestination()))))) {
						    	   boolean isNotArt = (!type.equals(TYPE_LIGNE_COMMANDE.ART.toString()) && !type.equals(TYPE_LIGNE_COMMANDE.ART_MENU.toString()));
						       %>
						               
							       <tr class="<%=classType%>" style="border-bottom: 1px dotted #777;<%=styleConfig+styleAnnul %>">
