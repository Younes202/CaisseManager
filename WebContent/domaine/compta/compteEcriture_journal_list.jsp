...
<std:form name="search-form">	
			...
			<table width="100%">
				<tr>
					...
					<td colspan="5" nowrap="nowrap">
						<std:select name="compte" required="true" addBlank="false"  type="string" data="${sourceArray }" width="280" forceWriten="true"/>
					</td>
					<td rowspan="2" valign="middle" align="center">
						<std:button action="admin.compteBancaire.find_ecriture_journal" targetDiv="div_result_livr" value="Rechercher" forceWriten="true" style="width:90px;height:50px;" />
					</td>
				</tr>
	...
	<div id="div_result_livr">
		<jsp:include page="/domaine/compta/compteEcriture_journal_result.jsp" />
	</div>
			</div>
		</div>
	</std:form>
