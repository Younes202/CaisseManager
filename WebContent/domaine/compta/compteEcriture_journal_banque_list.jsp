			...
			<table width="100%">
				<tr>
					...
					<td colspan="5" nowrap="nowrap">
						<std:select name="compte" required="true" type="long" data="${list_comptes }" key="id" labels="libelle" width="280" forceWriten="true"/>
					</td>
					<td rowspan="2" valign="middle" align="center" nowrap="nowrap">
						<std:button action="admin.compteBancaire.find_ecriture_banque" targetDiv="div_result_livr" value="Rechercher" forceWriten="true" style="width:90px;height:50px;" />
					</td>
				</tr>
		...
		<br>
			<!-- Liste des ecritures -->
				<div id="div_result_livr">
					<jsp:include page="/domaine/compta/compteEcriture_journal_banque_result.jsp" />
				</div>
			</div>
		</div>
	</std:form>
