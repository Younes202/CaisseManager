			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						...
						<li class="active"><a data-toggle="tab" href="#mouvement" wact="<%=EncryptionUtil.encrypt("pers.client.find_reduction")%>"> R&eacute;ductions </a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="widget-body">
			<div class="row">
				...
				<std:form name="search-form">
					<!-- Liste des employes -->
					<cplx:table name="list_caisseMouvement" transitionType="simple" width="100%" titleKey="caisseMouvement.list" initAction="pers.client.find_mvm_client">
						<cplx:header>
							<cplx:th type="empty" />
							...
							<cplx:th type="decimal" valueKey="caisseMouvement.mtt_reduction" field="caisseMouvement.mtt_reduction" width="150" />
							<cplx:th type="decimal" value="Art. offerts" field="caisseMouvement.mtt_art_offert" width="150" />
