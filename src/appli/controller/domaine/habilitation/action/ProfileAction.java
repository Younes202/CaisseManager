...
public class ProfileAction extends ActionBase {
	...
	public void work_init(ActionUtil httpUtil) {
		if(httpUtil.isEditionPage()){
			...
			boolean isAgri = SOFT_ENVS.agri.toString().equals(context);
			boolean isSyndic = SOFT_ENVS.syndic.toString().equals(context);
			//boolean isErp = SOFT_ENVS.erp.toString().equals(context);
			...
			mobileEnvs.put("mob-bo","Espace mobile bak-office");
			mobileEnvs.put("mob-synthese","Espace mobile synthèse");
			mobileEnvs.put("mob-utilitaire", "Espace mobile utilitaire");
			//--------------------------------
