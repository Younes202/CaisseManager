...
public class PrintRazLivraison {
    ...
    //
    public PrintRazLivraison(String titre, String date, List<RazDetail> data) {
    	this.titre = titre;
        this.data = data;
        this.date = date;
    ...
    public List<PrintPosDetailBean> buildMapData() {
        ...
        //
         for (RazDetail recap : data) {
             ...
             listPrintLins.add(new PrintPosDetailBean(BigDecimalUtil.formatNumber(recap.getMontant2()), X_MTT_START+50, y, PrintCommunUtil.CUSTOM_FONT_9));
		}   
