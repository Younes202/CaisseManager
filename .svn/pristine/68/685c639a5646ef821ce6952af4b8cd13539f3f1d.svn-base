...
//				int espaceMax = 100;//ENUM_TARIF_DISQUE.valueOf(ContextRestaurent.getSuperUserBean()).getEspace_disque()).getTaille();
//				int tailleReelle = FileUtilController.getEspaceUtilise(ContextAppli.getSuperUserBean().getId().toString());
//				
