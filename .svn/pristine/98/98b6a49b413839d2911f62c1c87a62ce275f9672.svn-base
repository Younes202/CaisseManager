...
<div class="page-header position-relative">
	<div class="header-title" style="padding-top: 4px;">
		<std:link actionGroup="U" classStyle="btn btn-default" action="caisse_restau.caisseConfigurationRestau.work_init_update" icon="fa-3x fa-pencil" tooltip="Modifier" />
