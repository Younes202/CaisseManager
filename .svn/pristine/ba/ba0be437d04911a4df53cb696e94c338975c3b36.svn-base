		...
		<c:forEach items="${listEcriture }" var="ecriture">
			...
			<c:if test="${not empty oldGroup2 && currentGroup2 != oldGroup2 }">
				<tr>
					...
					<td align="right" style="background-color: #f4f4f4;color: red;"><b><fmt:formatDecimal zeroVal="false" value="${totalDebit }"/></b></td>
					<td align="right" style="background-color: #f4f4f4;color: green;"><b><fmt:formatDecimal zeroVal="false" value="${totalCredit }"/></b></td>
				</tr>
			...
			<tr>
				...
				<!-- Debit et credit -->
				<td align="right" style="color: red;"><fmt:formatDecimal zeroVal="false" value="${(ecriture.sens=='D' && ecriture.montant!=0) ? ecriture.montant : null}"/></td>
				<td align="right" style="color: green;"><fmt:formatDecimal zeroVal="false" value="${(ecriture.sens=='C' && ecriture.montant != 0) ? ecriture.montant : null}"/></td>
			</tr>
