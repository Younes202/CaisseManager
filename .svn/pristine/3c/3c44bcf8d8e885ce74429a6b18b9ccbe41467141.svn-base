		...
		<std:form name="data-form">
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<%
				    request.setAttribute("tabName", "caisse");
					request.setAttribute("pAction", EncryptionUtil.encrypt("caisse.wizardInstall.initBO"));
					request.setAttribute("sAction", EncryptionUtil.encrypt("caisse.wizardInstall.initCuisine"));
					%>
