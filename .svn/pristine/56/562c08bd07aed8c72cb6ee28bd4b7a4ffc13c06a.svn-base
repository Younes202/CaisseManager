...
<%
		boolean isFromMnu = ControllerUtil.getMenuAttribute("tpMnu", request) != null;// Si menu
		if(!isFromMnu){%>	
	<div class="widget">
		<div class="tabbable">
		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="row" id="repartition_div">
					<jsp:include page="/domaine/caisse/dashboard/dashboard_repartition_include.jsp"></jsp:include>
				</div>	
			</div>
		</div>
	</div>
