...
<script type="text/javascript">
			$(document).ready(function (){
				...
				for (var i = 1; i < interval_tracker_id+2; i++){
				...
				interval_tracker_id = setInterval(function() {
					...
					if($("#detail-pres-div").length == 0 || $("#detail-pres-div").css("display") == 'none'){
						// Arreter les anciens timers
						for (var i = 1; i < interval_tracker_id+2; i++){
					        window.clearInterval(i);
						}
					}
				...
				$("#corp-div").css("width", (widowWidth)+"px");
...
<div class="page-header position-relative" style="position: relative; left: 0px; top: 0px; background: #262626; height: 42px;">
	...
	<div class="header-buttons">
		<a class="refresh" id="refresh-toggler" href="javascript:void(0);" wact="<%=EncryptionUtil.encrypt("caisse-web.presentoire.loadCommande")%>" targetDiv="detail-pres-div"> <i class="glyphicon glyphicon-refresh"></i>
		</a>
	</div>
	<!--Header Buttons End-->
</div>
...
<div class="page-body" style="margin: 0px; overflow: auto;" id="detail-pres-div"></div>
