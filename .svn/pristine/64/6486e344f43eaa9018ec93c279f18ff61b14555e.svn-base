...
<div class="page-header position-relative">
	<div class="header-title" style="padding-top: 4px;">
		<std:link classStyle="btn btn-default" action="pers.client.init_situation" params="bck=1" icon="fa fa-3x fa-mail-reply-all" tooltip="Retour &agrave; la recherche" />
	</div>
	<!--Header Buttons-->
	...
	<div class="row">
     ...
     <%} %>   
		...
		<div class="widget-body">
				...
				<div class="row">
					<cplx:table name="list_mouvement" transitionType="simple" width="100%" title="Etat client" initAction="pers.client.situation_detail" autoHeight="true" checkable="false" >
						<cplx:header>
