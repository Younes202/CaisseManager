...
if (location.pathname != "/index-rtl-fa.html" && location.pathname != "index-rtl-ar.html") {
    if (readCookie("rtl-support")) {
        ...
        $('.navbar-brand small img').attr('src', 'resources/img/logo-rtl.png');
        if (rtlchanger != null)
...
//    if (readCookie("navbar-fixed-top") != null) {
        if (readCookie("navbar-fixed-top") == "true" || readCookie("navbar-fixed-top") == null) {
...
//    if (readCookie("sidebar-fixed") != null) {
        if (readCookie("sidebar-fixed") == "true" || readCookie("sidebar-fixed") == null) {
...
//    if (readCookie("breadcrumbs-fixed") != null) {
        if (readCookie("breadcrumbs-fixed") == "true" || readCookie("breadcrumbs-fixed") == null) {
...
//    if (readCookie("page-header-fixed") != null) {
        if (readCookie("page-header-fixed") == "true" || readCookie("page-header-fixed") == null) {
